...
public class CreateCourse extends GoToAdmin {
	...
	public void getCreateCours() throws IOException {
		...
		FileInputStream f1=new FileInputStream("C:\\Users\\hp\\Downloads\\Qualicoach\\Qualicoach-Automation-master\\Mavenjava\\src\\main\\java\\Qualitest\\Mavenjava\\input.properties");
		p.load(f1);
