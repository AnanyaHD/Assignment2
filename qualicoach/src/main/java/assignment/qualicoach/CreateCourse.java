...
public class CreateCourse extends GoToAdmin {
	...
	public void getCreateCours() throws IOException {
		...
		FileInputStream f1=new FileInputStream("C:\\Users\\hp\\eclipse-workspace\\qualicoach\\data.properties");
		p.load(f1);
		...
		driver.findElement(By.cssSelector("div#id_summary_editoreditable")).sendKeys("This course contains Selenium Java courses for Beginner's");
